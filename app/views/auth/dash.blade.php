      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li id= "liSoci" class= "lis" onclick="addClassActive('liSoci');showView('social','ocultar')"><a href="#">Social Networking</a></li>
            <li id= "liFavor" class= "lis" onclick="addClassActive('liFavor');showView('favor','ocultar')"><a href="#">favorites</a></li>
            <li id= "liReco" class= "lis" onclick="addClassActive('liReco');showView('reco','ocultar')"><a href="#">Recommended</a></li>
        ...
        <div id="reco" class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 ocultar" style="display:none" >
                    ...
                    <div class="panel panel-default">
                      <div class="panel-body">
                        ...
                        {{ Form::open(['route' => 'asignTask', 'method' => 'POST', 'role' => 'form','files' => true]) }}
                          ...
                          {{ Form::text('description', '', ['id' => 'descripcion', 'class' => 'form-control', 'placeholder' => 'Asunto', 'autofocus' => '']) }}
                          </br>
